...
public class DataManagerTest {
    ...
    @Before
    public void setUp() {
        mDataManager = new DataManager(mMockRouter);
    }
    ...
    public void getPokemonListCompletesAndEmitsPokemonList() {
        ...
        Router.PokemonListResponse pokemonListResponse =
                new Router.PokemonListResponse();
        pokemonListResponse.results = namedResourceList;

        when(mMockRouter.getPokemonList(anyInt()))
    ...
    public void getPokemonCompletesAndEmitsPokemon() {
        ...
        when(mMockRouter.getPokemon(anyString()))
